...
export default function OrgChartPage() {
  ...
  // helper convert
  const mapToEmployeeNode = (nodeDatum: EmployeeTreeNodeDatum): EmployeeNode => {
    return {
      id: nodeDatum.id || "",
      name: nodeDatum.name || "",
  ...
  return (
    ...
    <div ref={treeContainer} className="rounded-md bg-white border shadow-sm border-grayscale-20 p-6 flex flex-col gap-4" style={{ width: '100%', height: '80vh' }}>
      <Tree
        data={data}
        ...
        return (
            ...
            >
                ...
                <div className="absolute top-2 right-2">
                    <button onClick={() => handleEditClick(empNode)}>⋮</button>
                </div>
