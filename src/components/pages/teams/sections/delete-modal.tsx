      ...
      <AlertDialogContent className="w-full max-w-md sm:max-w-md text-center bg-white">
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <div className="text-gray-600 text-sm mb-4">
            Deleting this team may affect any existing job position mappings
            linked to it. If mappings have been set up, you’ll need to reassign
            affected positions manually.
          </div>
        </div>
